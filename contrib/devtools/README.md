...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_cpacoin: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_cpacoin: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_cpacoin: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_cpacoin: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
