...
Cpacoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Cpacoin Core, where everyone uses
...
pay attention to for reviewers of Cpacoin Core code.

General Cpacoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Cpacoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
