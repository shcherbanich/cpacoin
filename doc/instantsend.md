...
This mechanism has been integrated into Bitcore-Node-Cpacoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cpacoinpay/insight-api-cpacoin#web-socket-api](https://github.com/cpacoinpay/insight-api-cpacoin#web-socket-api) 
* API: [https://github.com/cpacoinpay/insight-api-cpacoin#instantsend-transactions](https://github.com/cpacoinpay/insight-api-cpacoin#instantsend-transactions) 
...
By default, the Cpacoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cpacoin Core daemon:
