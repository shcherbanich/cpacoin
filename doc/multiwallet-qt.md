...
Only requiring some minor changes is cpacoin.cpp.
...
Changes to cpacoin.cpp
----------------------
cpacoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
