...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CpacoinNetwork") type = CpacoinNetwork;
    if(strType == "CpacoinNetworkVariable") type = CpacoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CpacoinNetwork) s = "CpacoinNetwork";
    if(type == CpacoinNetworkVariable) s = "CpacoinNetworkVariable";
