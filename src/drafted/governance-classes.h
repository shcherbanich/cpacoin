 ...
 *
 *   // network
 *   CCpacoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.cpacoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCpacoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCpacoinNetwork(UniValue objIn)
    {
...
// // can be under: CpacoinNetwork
// //   -- signature requirements : Key1(User)
// class CCpacoinNetworkVariable : public CGovernanceObject
// {
// private:
