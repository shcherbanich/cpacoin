    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Cpacoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cpacoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cpacoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Cpacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cpacoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cpacoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cpacoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cpacoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a cpacoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cpacoin Core help message to get a list with possible Cpacoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Cpacoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cpacoin network", "", count));
}
...
{
    QString strTitle = tr("Cpacoin Core"); // default title
