    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CPACOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("CPACOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CPACOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CPACOIN-traditional"), QVariant("trad"));
