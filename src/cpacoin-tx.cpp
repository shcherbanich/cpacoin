...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Cpacoin Core cpacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cpacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cpacoin transaction") + "\n" +
              "  cpacoin-tx [options] -create [commands]   " + _("Create hex-encoded cpacoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cpacoin transaction
