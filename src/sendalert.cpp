...
2. run cpacoind with -printalert or -sendalert like this:
   /path/to/cpacoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cpacoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Cpacoin Core:0.12.0.58/"));
