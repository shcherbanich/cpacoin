...
{
    if(fLiteMode) return; // ignore all Cpacoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Cpacoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("cpacoin-privatesend");
